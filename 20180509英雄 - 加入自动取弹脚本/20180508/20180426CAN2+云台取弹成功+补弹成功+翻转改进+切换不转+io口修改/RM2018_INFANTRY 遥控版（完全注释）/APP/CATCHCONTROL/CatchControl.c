...
uint32_t tG_ms = 1000 ;
uint32_t tH_ms = 500 ;
uint32_t tI_ms = 500 ;           //最后一步收回爪子到清空寄存器给的时间

uint32_t tA_Init_ms = 0 ;
uint32_t tB_Init_ms = 500 ;          //大约1秒
uint32_t tC_Init_ms = 5000 ;
uint32_t tD_Init_ms = 500 ;          //[(8192*3-11500)/(100*0.03)]*2 安全系数
uint32_t tE_Init_ms = 2000 ;          
uint32_t tF_Init_ms = 100 ;
uint32_t tG_Init_ms = 1000 ;
uint32_t tH_Init_ms = 500 ;
uint32_t tI_Init_ms = 500 ;
